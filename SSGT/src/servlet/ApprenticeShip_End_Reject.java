...
public class ApprenticeShip_End_Reject extends HttpServlet {
	...
	throws ServletException, IOException {
		...
		try{
			...
			if(Richiesta.rifiuta(request.getSession(false).getAttribute("userType")))
			{
				out.print("Rifiutato con successo");
			}
			else
			{
